...
<body>
	...
	<div id="login">
		...
		<div class="loginContent">
			...
			<?php }?>
			<form action="<?= base_url()?>admin/login/validar" method="post">
    ...
    <div id="container">
		...
		<p align="center">			
			...
			<p align="center"><img src="<?php echo base_url();?>site/img/login/babayaga.jpg"></p>
        	<p style="margin-top: 30px;">Para ter acesso ao sistema, clique <strong>"Acessar"</strong><br />
			<small>(<b>OBS:</b> Este sistema é para uso interno da Babayagá! Somentes usuários previamente cadastrados terão acesso. Em caso de dúvida procure o responsável.</small>
			</p>
		</p>	
		</div><!-- / content -->
        <div class="clearfix"></div>
