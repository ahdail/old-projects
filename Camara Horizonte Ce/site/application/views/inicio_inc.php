...
<link href="<? echo base_url()?>css/default.css" rel="stylesheet" type="text/css" media="screen" />
<style type="text/css">
<!--

#slidebox{position:relative; border:2px solid #FDC00F; margin:20px auto;}
#slidebox, #slidebox .content{width:510px;}
...
<div id="header">
	...
	<div id="menu">
		<ul id="main">
			...
			<li><a href="<?php echo base_url();?>acessoria">Fale com seu vereador</a></li>			
			<li><a href="<?php echo base_url();?>acessoria">Assessoria</a></li>			
			<li><a href="<?php echo base_url();?>acessoria">Intranet</a></li>	
		</ul>
	</div>
