<?php include 'inicio.inc.php';?>
        ...
        <div class="block" id="block-forms-2">
          ...
          <div class="content">
            ...
            <div class="inner">
              <form action="#" class="form" action="<?php echo base_url()?>admin/foto/manter" enctype="multipart/form-data" method="post">
                <div class="columns wat-cf">
                  ...
                  <div class="column right">
                    ...
                    <div class="group">
                      ...
                      <div>
                        <input type="radio" name="mostrar" id="radio_1" class="checkbox" value="S" /> <label for="radio_1" class="radio">Sim</label>
                      </div>
                      <div>
                        <input type="radio" name="mostrar" id="radio_2" class="checkbox" value="N" /> <label for="radio_2" class="radio">Não</label>
                      </div>
                    </div>
