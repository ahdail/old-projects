...
class Enquete extends Controller {
	...
	function resultado()
	{
		$enquete['pergunta'] = $this->EnqueteModel->todasPerguntas();
		$this->load->view('admin/enqueteresultado',$enquete);
	}
	
	function enqueteResultado($idPergunta)
	{
		$var['pergunta'] = $this->EnqueteModel->todasPerguntas();
		$var['total']= $this->EnqueteModel->totalPergunta($idPergunta);
		$var['respostas'] = $this->EnqueteModel->totalResposta($idPergunta);
		$var['idPergunta'] = $idPergunta;
		$this->load->view('admin/enqueteresultado',$var);
	}
