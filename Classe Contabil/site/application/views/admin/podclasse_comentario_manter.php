...
<?php } ?>
<form method="post" action="<?= base_url()?>admin/podClasse/comentarioManter" onsubmit="finalForm();">
	<h1>CADASTRO DE COMENTÁRIO DOS VÍDEOS</h1>
	<ul>
		<li>
			<label>Nome</label>
	...
	<input type="hidden" name="idComentario" value="<?=$row['email']?>">
</form>
