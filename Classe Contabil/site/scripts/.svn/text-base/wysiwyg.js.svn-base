 ...
 *
 * $Id: wysiwyg.js,v 1.2 2009/01/19 18:29:44 tibirabotto Exp $
 *
...
var WYSIWYG = {
	...
	Settings: function() {
		...
		// Images Directory
		// Mudar quando for para o servidor
		this.ImagesDir = "http://www.classecontabil.com.br/v3/site/icons/";
		
		// Popups Directory
		// Mudar quando for para o servidor
		this.PopupsDir = "http://www.classecontabil.com.br/v3/site/popups/";
		
		// CSS Directory File
		// Mudar quando for para o servidor
		this.CSSFile = "http://www.classecontabil.com.br/v3/site/styles/wysiwyg.css";
		...
		this.DefaultStyle = "font-family: Verdana; font-size: 9px; color:#757575; background-color: #FFFFFF";
		
		// Stylesheet if editor is disabled
		this.DisabledStyle = "font-family: Verdana; font-size: 9px; color:#757575; background-color: #EEEEEE";
