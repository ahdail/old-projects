function preparaEditor(nome) {
	...
	oEdit1.cmdAssetManager = "modalDialogShow('/equipePi/classe/ci/site/js/wysiwyg/assetmanager/assetmanager.php',640,465)"; //Command to open the Asset Manager add-on.
