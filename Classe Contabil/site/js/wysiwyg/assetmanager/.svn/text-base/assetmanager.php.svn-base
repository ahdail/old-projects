...
<td valign=top style="background:url('bg.gif') no-repeat right bottom;padding-top:5px;padding-left:5px;padding-right:5px;padding-bottom:0px;">
		...
		<td>
				...
				<td nowrap>
					<span onClick="newFolder()" style="cursor:pointer;"><u><span name="txtLang" id="txtLang" <?echo $sFolderAdmin;?>>Nova&nbsp;Pasta</span></u></span>&nbsp;
					<span onClick="deleteFolder()" style="cursor:pointer;"><u><span name="txtLang" id="txtLang" <?echo $sFolderAdmin;?>>Deletar&nbsp;Pasta</span></u></span>
				</td>
		...
		<td>
				...
				<span name="txtLang" id="txtLang">Arquivo</span>: <input type="file" id="File1" name="File1" class="inpTxt">&nbsp;
				<input name="btnUpload" id="btnUpload" type="button" value="enviar" onClick="upload()" class="inpBtn" onMouseOver="this.className='inpBtnOver';" onMouseOut="this.className='inpBtnOut'">
				</form>
				</div>
		</td>
		</tr>
