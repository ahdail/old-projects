...
<?php }?>
	<table class="listar" cellspacing="1" cellpadding="1" style="width: 100%">
		<tr class="titulo">
			...
			<td bgcolor="#CCCCCC">Conteúdo</td>
			<!--  <td align="center">Qtd Acessos</td>-->
			<td align="center">Exibir</td>
			<td align="center" bgcolor="#CCCCCC" width="50px">Ações</td>
		</tr>
	...
	<br>
	<div align="center"><input type="button" value="Novo Conteúdo" onclick="window.location.href='<?php echo base_url()?>admin/conteudo/detalhar'"; /></div>
</body>
</html>
<?php
echo $pag;
