<?php include("inicio.inc.php"); ?>
  ...
  <div id="areadefoto">
    ...
    <span class="textonormal"><a href="<?php echo base_url();?>evento/show/<?echo $row['data'] ?>"><?php echo sqlToDate($row['data']) ?> - <?php echo $row['titulo'] ?></a></span><br /><br />
	<?php } ?>
    <p>&nbsp;</p>
  </div>
  ...
  <div id="menu_colecoes">
    ...
    <p><span class="textonormal"><a href="#"><?php echo sqlToDate($ultimo['data'])?><br />
...
<?php } else {?>
 ...
 <div id="menu_colecoes">
    ...
    <p><span class="textonormal"><a href="#"><?php echo sqlToDate($atual['data'])?><br />
