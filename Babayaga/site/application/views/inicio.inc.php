         ...
         <tr>
           <td width="27%">
			...
			<form id="formularioContato" name="formularioContato" method="post" action="<?php echo base_url();?>newsletter">
				<input name="campoNome" type="text" class="formulario_news" id="campoNome" value="digite aqui seu nome" onBlur="if(this.value=='') {this.value='digite aqui seu nome';}" onFocus="if(this.value=='digite aqui seu nome') {this.value='';}" /><br />
				<input name="campoEmail" type="text" class="formulario_news" id="campoEmail" value="digite aqui seu email" onBlur="if(this.value=='') {this.value='digite aqui seu email';}" onFocus="if(this.value=='digite aqui seu email') {this.value='';}" /><br>
           ...
           <td width="30%" valign="bottom"><a href="<?php echo base_url();?>livezilla" target="_blank"><img src="<?php echo base_url();?>site/images/atendimento-on-line.jpg" width="130" height="37" border="0"/></a></td>
         </tr>
       </table>
      <br />
    </div>
