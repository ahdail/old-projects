...
<div id="areadefoto">
	...
	<p class="texto_bold_italic"> Dicas anteriores</p>
	
	<?php foreach ($dica as $row) { ?>
	<span class="textonormal"><?php echo sqlToDate($row['data']) ?> -  
	<a href="<?php echo base_url();?>dica/ver/<?php echo $row['id']?>"><?php echo $row['titulo'] ?> </a></span><br />
	<?php } ?>
	<p>&nbsp;</p>
</div>
<?php if ($ultima['id']){?>
<div id="areanoticias">
    <span class="TitulosGrandes">Dica Babayaga</span>
